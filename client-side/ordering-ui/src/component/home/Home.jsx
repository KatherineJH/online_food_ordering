    ...
    <div className="pb-10">
      <section className="banner -z-50 relative flex flex-col justify-center items-center">
        <div className="w-[50vw] z-10 text-center">
          <p className="w-2x1 lg:text-6xl font-bold z-10 py-5 bg-white/50 rounded-md shadow-md">
            Vibrant Fresh Grub
          </p>
      ...
      <section className="p-10 lg:py-10 lg:px-20">
        <p className="text-2xl font-semibold py-3 pb-10">Top Meals</p>
        <MultiItemCarousel />
      </section>
      <section className="px-5 lg:px-20 pt-10">
        <h1 className="text-2xl font-semibold"> Tastes of the Month</h1>
