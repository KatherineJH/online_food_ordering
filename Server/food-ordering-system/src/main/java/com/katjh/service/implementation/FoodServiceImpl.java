...
public class FoodServiceImpl implements FoodService {
    ...
    /**
     * Food 객체를 삭제하는 것이 아니라 Food와 Restaurant 사이의 관계를 끊는 작업 foodRepository.save(food)로 그 변경 사항을
     * 데이터베이스에 반영
     *
     * @param foodId the id of the food to be deleted
     * @throws Exception if the food is not found (Food 객체 자체를 삭제하고 싶다면 foodRepository.delete(food)를
     *     사용)
     */
    @Override
